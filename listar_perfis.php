...
<div class="container-fluid p-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-0 text-dark">Gerenciamento de Perfis</h4>
            <p class="text-muted small mb-0">Perfis e especializações odontológicas</p>
        </div>
        
        <button onclick="abrirModal('form_perfil.php')" class="btn btn-primary btn-sm shadow-sm">
                        ...
                        <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td class="text-end pe-3">
                                    ...
                                    <button onclick="abrirModal('form_perfil.php?id=<?= $perfil['id'] ?>')" class="btn btn-sm btn-outline-primary" title="Editar">
  ...
  <div class="modal-dialog modal-dialog-centered"> 
    <div class="modal-content border-0 shadow">
      <div class="modal-header bg-light py-2">
        <h5 class="modal-title fs-6 fw-bold text-secondary"><i class="fa-solid fa-info-circle me-2"></i>Detalhes do Perfil</h5>
...
<div class="modal fade" id="modalEditor" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
  <div class="modal-dialog modal-lg modal-dialog-centered"> 
    <div class="modal-content border-0 shadow">
      <div class="modal-header bg-light py-2">
        <h5 class="modal-title fs-6 fw-bold text-secondary"><i class="fa-solid fa-stethoscope me-2"></i>Cadastro de Perfil</h5>
